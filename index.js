...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1230392916002869368/1230398184644153344/gavaw.jpg?ex=66332c9a&is=6620b79a&hm=c00ff85e97bfd93d5db33d2e770955ac7030b898bf8e8c03b9d6e24ddadc91eb&']; //รูปใหญ่
    ...
    const yyyt = ['migael']; // ชื่อ button1
    const ddds = ['https://open.spotify.com/user/31qbemvqrt2ivwiszmmoaosgeuam?si=skWFV5EYTV-KHLjMKm9mug']; // ลิ้ง button1

   const iooi = ['migael']; // ชื่อ button 2
   const iiio = ['https://www.instagram.com/migael_xux?igsh=MWpkbXFjcmlma3Nveg==']; // ลิ้ง button 2
